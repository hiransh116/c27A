...
roof=new Roof(400,50);
  b1=new Bob(240,200,40);
  b2=new Bob(320,200,40);
 b3= new Bob(400,200,40);
 b4=new Bob(480,200,40);
 b5=new Bob(560,200,40);
...
function keyPressed(){
  if(keyCode===UP_ARROW){
    Matter.Body.applyForce(b1.body,b1.body.position,{x:240,y:200});
  }
}